(function () {
  ...
  var STORAGE_KEY = 'python_exam_progress';
  var CHAPTER_STORAGE_KEY = 'python_chapter_progress';
  ...
  var CHAPTERS = [
    { id: '01-introduction-to-python-and-setup',                         title: 'Ch 1: Introduction to Python & Setup',            number: 1,  section: 'Foundation' },
    { id: '02-python-basics-variables-data-types-operators',            title: 'Ch 2: Variables, Data Types & Operators',         number: 2,  section: 'Foundation' },
    { id: '03-control-flow-conditionals-and-loops',                     title: 'Ch 3: Control Flow — Conditionals & Loops',      number: 3,  section: 'Foundation' },
    { id: '04-functions-and-scope',                                      title: 'Ch 4: Functions & Scope',                        number: 4,  section: 'Foundation' },
    { id: '05-data-structures-lists-tuples-sets-dictionaries',          title: 'Ch 5: Data Structures — Lists, Tuples, Sets, Dicts', number: 5,  section: 'Core Skills' },
    { id: '06-strings-and-string-manipulation',                         title: 'Ch 6: Strings & String Manipulation',            number: 6,  section: 'Core Skills' },
    { id: '07-file-io-and-exception-handling',                          title: 'Ch 7: File I/O & Exception Handling',            number: 7,  section: 'Core Skills' },
    { id: '08-modules-packages-and-standard-library',                   title: 'Ch 8: Modules, Packages & Standard Library',     number: 8,  section: 'Core Skills' },
    { id: '09-object-oriented-programming',                              title: 'Ch 9: Object-Oriented Programming',               number: 9,  section: 'Advanced' },
    { id: '10-decorators-generators-and-context-managers',              title: 'Ch 10: Decorators, Generators & Context Managers', number: 10, section: 'Advanced' },
    { id: '11-working-with-apis-and-external-libraries',                title: 'Ch 11: Working with APIs & External Libraries',   number: 11, section: 'Advanced' },
    { id: '12-testing-and-debugging',                                   title: 'Ch 12: Testing & Debugging in Python',           number: 12, section: 'Advanced' },
    { id: '13-advanced-topics-multithreading-multiprocessing-async',    title: 'Ch 13: Advanced — Multithreading, Multiprocessing, Async', number: 13, section: 'Production & Interview Prep' },
    { id: '14-python-for-data-science',                                 title: 'Ch 14: Python for Data Science (NumPy, Pandas)',  number: 14, section: 'Production & Interview Prep' },
    { id: '15-web-development-with-python',                             title: 'Ch 15: Web Development with Python (Flask/FastAPI)', number: 15, section: 'Production & Interview Prep' },
    { id: '16-database-interaction-and-orm',                            title: 'Ch 16: Database Interaction & ORM',               number: 16, section: 'Production & Interview Prep' },
    { id: '17-interview-questions-and-answers',                         title: 'Ch 17: Interview Questions & Answers',           number: 17, section: 'Bonus' },
    { id: '18-real-world-scenarios-and-coding-problems',               title: 'Ch 18: Real-World Scenarios & Coding Problems',   number: 18, section: 'Bonus' }
  ];
  ...
  function buildDashboardHTML() {
    ...
    html += '  <p class="exam-progress-summary">Track your Python learning journey — from chapters to practice exams</p>';
    html += '</div>';
    ...
    var sections = ['Foundation', 'Core Skills', 'Advanced', 'Production & Interview Prep', 'Bonus'];
    ...
    TESTS.forEach(function (t) {
      ...
      html += '    <p>50 questions across all domains | 60 min</p>';
      ...
      html += '    </div>';
      html += '    <a href="/docs/' + (18 + t.number) + '-exam-practice-test-' + t.number + '/" style="display:inline-block;margin-top:0.75rem;font-size:0.85rem;">\u2192 Open test</a>';
      html += '  </div>';
    });
